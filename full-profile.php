...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
    <table width="100%" border="0">
      <?php
          $ret= mysql_query("SELECT * FROM users where emailid = '".$_GET['id']."'");
          while($row=mysql_fetch_array($ret)) { ?>
            ...
            <tr>
              <td colspan="2"  class="font"><?php echo ucfirst($row['fname']);?> <?php echo ucfirst($row['sname']);?>'S <span class="font1"> information &raquo;</span> </td>
            </tr>
            <tr>
