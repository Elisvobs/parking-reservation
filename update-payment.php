<?php
    ...
    $customer_id=$_POST['customer_id'];
		...
		$query="update payments set customer_id=?,num_plate=?,amount_charged=?,amount_paid=? where id=?"
		$stmt = $mysqli->prepare($query);
		$rc=$stmt->bind_param('isss',$customer_id,$num_plate,$amount_charged,$amount_paid);
		$stmt->execute();
		echo"<script>success('Payment Info Successfully Updated');</script>";
							...
							<div class="row">
								<div class="col-md-12">
									<div class="panel panel-primary">
										<div class="panel-heading">Update Payment Info</div>
                              ...
                              <div class="col-sm-3">
                                <input type="text" name="customer_id" id="customer_id"  class="form-control"  value="<?php echo $row->customer_id;?>">
                                ...
                                <label class="col-sm-2 control-label">Number Plate : </label>
															...
															<div class="form-group">
																<label class="col-sm-2 control-label">Amount Charged : </label>
																<div class="col-sm-3">
																	<input type="text" name="timeA" id="timeA" min="10/18/2019"  class="form-control" value="<?php echo $row->amount_charged;?>">
																</div>
															<div class="form-group">
																<label class="col-sm-2 control-label">Amount Paid : </label>
																<div class="col-sm-3">
																	<input type="text" name="timeD" id="timeD"  class="form-control" value="<?php echo $row->amount_paid;?>">
																</div>
															</div>
														</div>
												<?php } ?>
